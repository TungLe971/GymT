...
import { Layout, Input, Button, Dropdown, Menu, Avatar, FloatButton } from 'antd';
...
const Header = () => {
  ...
  const menu = (
    <Menu>
      <Menu.Item key="1" onClick={onHandleProfile} icon={<UserOutlined />}>
        Profile
      </Menu.Item>
      ...
      <Menu.Divider />
      <Menu.Item key="3" onClick={onHandleLogout}>
